...
class DataTransformation:
    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        Description :   This method initiates the data transformation
                        component for the pipeline

        Output      :   data transformer steps are performed
                        and preprocessor object is created
        On Failure  :   Write an exception log and then raise an exception
        """
        try:
            if self.data_validation_artifact.validation_status:
                ...
                company_age_train = CURRENT_YEAR - input_feature_train_df['yr_of_estab']
                input_feature_train_df['company_age'] = company_age_train
                ...
                company_age_test = CURRENT_YEAR - input_feature_test_df['yr_of_estab']
                input_feature_test_df['company_age'] = company_age_test
                ...
                logging.info(
                    "Exited initiate_data_transformation "
                    "method of Data_Transformation class"
                )
