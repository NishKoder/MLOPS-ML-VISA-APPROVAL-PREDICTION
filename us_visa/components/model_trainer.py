...
from us_visa.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, \
    save_object
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[
        object, object]:
        """
        ...
        try:
            ...
            x_train, y_train, x_test, y_test = train[:, :-1], train[:, -1], test[:,
                                                                            :-1], test[
                                                                                  :, -1]
