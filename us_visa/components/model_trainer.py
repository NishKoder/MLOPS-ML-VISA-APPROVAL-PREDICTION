...
class ModelTrainer:
    def __init__(
        ...
        """
        :param data_transformation_artifact: DataTransformation artifact for
                                            model training
        :param model_trainer_config: Model trainer config
        """
    ...
    def get_model_object_and_report(
        ...
        Description :   This function uses neuro_mf to get the best model object and
