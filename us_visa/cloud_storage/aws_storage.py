...
class SimpleStorageService:
    ...
    def s3_key_path_available(self, bucket_name, s3_key) -> bool:
        try:
            ...
            file_objects = [file_object for file_object in
                            bucket.objects.filter(Prefix=s3_key)]
    ...
    @staticmethod
    def read_object(object_name: str, decode: bool = True,
                    make_readable: bool = False) -> Union[StringIO, str]:
        """
    ...
    def get_file_object(self, filename: str, bucket_name: str) -> Union[
        List[object], object]:
        """
